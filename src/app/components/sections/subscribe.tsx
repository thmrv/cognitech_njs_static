...
export default function Subscribe() {
    ...
    return (<div className="subscribe flex flex-row pt-16 pb-16 w-full flex flex-col header w-full flex flex-col bg-white m-auto max-w-screen-2xl" suppressHydrationWarning>
